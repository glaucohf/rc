...
$mail->AddAddress('contato@icij.com.br', '[KC PROFESSIONAL] Turma 07'); #---alterar---/
#$mail->AddCC('contato@riocoaching.com.br', '[KC PROFESSIONAL] Turma 06'); // Copia
#$mail->AddAddress('glaucohf@gmail.com', '[KC PROFESSIONAL] Turma 06'); # Os campos podem ser substituidos por variáveis ---alterar---
...
$mail->Subject = "[KC PROFESSIONAL] Turma 07"; # Assunto da mensagem

$mail->Body = "<h2><strong>[KC PROFESSIONAL] Turma 07</h2></strong><BR><strong>Mensagem: </strong>" . $_POST['message'] . "<BR><strong>De: </strong>" . $_POST['name'] . "<BR><strong>Telefone: </strong>" . $_POST['phone'] . "<BR><strong>Email:</strong> " . $_POST['email']. "<BR><strong>Parametros UTM: </strong><BR>" . $_POST['utm_data'] . "<BR><strong>Mensagem do IP:</strong>" . $_POST['ip'];
